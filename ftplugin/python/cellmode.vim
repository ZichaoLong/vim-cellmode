...
function! CopyToTmux(code)
  ...
  " Simulate triple enter to run loaded code
  call CallSystem('tmux send-keys -t "' . target . '" Enter Enter Enter')
endfunction
...
if g:cellmode_default_mappings
    ...
    nnoremap <buffer> <silent> <Leader>j /#%%<CR>
    nnoremap <buffer> <silent> <Leader>k ?#%%<CR>
endif
